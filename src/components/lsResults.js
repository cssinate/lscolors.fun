export let lsResults = [{
  ...
  {
    code: 'ow',
    description: 'directory, writable by others (o+w)',
    fg: 34,
    bg: 42,
    eff: '00'
  },
  {
    code: 'st',
    description: 'directory, sticky, not writable by others (+t)',
    fg: 37,
    bg: 44,
    eff: '00'
  },
  {
    code: 'tw',
    description: 'directory, sticky, writable by others (+t,o+w)',
    fg: 30,
    bg: 42,
    eff: '00'
  },
